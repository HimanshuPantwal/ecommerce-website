const TestimonialCard = ({ imgSrc, description, name, role, bgColor, mode }) => {
    return (
      <div
        className=" lg:mb-0 mb-6 p-4 rounded-2xl hover:scale-105 transition-all hover:duration-300 h-[25rem]"
      >
        <div className="h-full text-center rounded-xl flex flex-col items-center justify-center p-2" style={mode === 'dark' ? bgColor : { background: 'transparent' }}>
          <img
            alt="testimonial"
